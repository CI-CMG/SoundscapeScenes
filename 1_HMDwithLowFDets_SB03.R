...
# MANTA HMD DATA ####
# by deployment
inSites = c( "SB03_14", "SB03_15", "SB03_16", "SB03_17", "SB03_18", "SB03_19")
ver = "manta_9.6.14"
...
cntdul = 0
cnt00 = 0
for (s in 1:length(inSites)  ) { #  1:length(inSites) s = 4
  inS = inSites[s] 
  ...
  dirDets = paste0(dirTop, "//", inS, "\\detections\\")
  #dirDets = paste0(inDir,"\\detections\\")
...
# COMBINE DETECTIONS ####
for (s in 1:length(inSites)  ) { # length(inSites) s = 1
